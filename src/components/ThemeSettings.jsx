...
const ThemeSettings = () => {
  ...
  return (
    ...
    <div className='bg-half-transparent w-screen fixed nav-item top-0 right-0'>
      <div className={ currentMode === 'Dark' ? 'bg-black float-right h-screen text-white w-400 border-white':'float-right h-screen dark:text-gray-800 bg-white border-black w-400 '} >
        {/* settings + icon */}
